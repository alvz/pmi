...
<?php
	...
	echo GxHtml::closeTag('ul');
?><h2>Rujukan Internals</h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->rujukanInternals as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('rujukanInternal/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
		echo GxHtml::closeTag('li');
	}
	echo GxHtml::closeTag('ul');
?>